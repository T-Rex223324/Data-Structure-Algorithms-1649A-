...
class MyArray<T> {
    ...
    public void add(T item) {
        add(size, item); // Calls the overloaded method to insert at the end
    }
...
public class Bookstore {
    ...
    public static void main(String[] args) {
        ...
        measureMyArrayOperations();
        measureMyQueueOperations();
        measureQuickSort();
...
//    }
            ...
            if (order.customerName.toLowerCase().contains(keyword) ||
                ...
                for (int i = 0; i < order.booksOrdered.size(); i++) {
                    if (order.booksOrdered.get(i).title.toLowerCase().contains(keyword)||
                            order.booksOrdered.get(i).code.toLowerCase().contains(keyword)) {
                        System.out.println(order);
                        found = true;
                        break;
                    }
    ...
    private static void measureMyArrayOperations() {
        ...
        // Measure time for accessing elements
        ...
        System.out.println("MyArray Operations:");
        System.out.println("Time taken to add " + n + " elements: " + (endAdd - startAdd) + " ns");
        System.out.println("Time taken to access " + n + " elements: " + (endAccess - startAccess) + " ns");
    }

    private static void measureMyQueueOperations() {
        MyQueue<Integer> myQueue = new MyQueue<>();
        int n = 10000;

        // Measure time for enqueue operation
        ...
        // Measure time for dequeue operation
        ...
        System.out.println("MyQueue Operations:");
        System.out.println("Time taken to enqueue " + n + " elements: " + (endEnqueue - startEnqueue) + " ns");
        System.out.println("Time taken to dequeue " + n + " elements: " + (endDequeue - startDequeue) + " ns");
    }
    ...
    private static void measureQuickSort() {
        ...
        // Initialize books with random titles
        for (int i = 0; i < n; i++) {
            books[i] = new Book("Book" + random.nextInt(n), "#" + i, random.nextDouble() * 100, 1);
        }

        long startSort = System.nanoTime();
        quickSortBooksByTitle(books, 0, books.length - 1);
        long endSort = System.nanoTime();

        System.out.println("QuickSort:");
        System.out.println("Time taken to sort " + n + " books: " + (endSort - startSort) + " ns");
    }
